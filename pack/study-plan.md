...
- If you are new to Python, finish [Python](#warmup) first (20 short sessions in the page). Scratch ideas in [Sandbox](#sandbox) — type, Run, read the console. Then sit the lab on **7 · Coding** until the tests are green. Stubs skip; implemented functions are scored against the answer key.
